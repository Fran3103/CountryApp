...
const border = borders.map((borde)=>{return(
    <button key={borde} className=" bg-bgLightGray text-base rounded-md shadow-xl px-6 py-2 dark:bg-DarkBlue dark:text-bgLightGray">
        {borde}
    </button>
  ...
  return (
    <div className="bg-bgLightGray  dark:bg-bgVeryDarkBlue duration-500  dark:duration-500 h-screen w-full m-auto max-w-[1440px]">
        <button className="mt-5 mb-6 lg:mt-24 lg:-mb-6 ml-12 bg-bgLightGray px-9 py-2 dark:text-DarkGray shadow-xl dark:bg-DarkBlue text-DarkBlue rounded-md">Back</button>
